import { parseMonto, formatoMoneda, conectarInputMonto, formatoInputMonto } from './utils.js';
...
export function initBna(){
  ...
  monedaToggle.querySelectorAll('button').forEach(btn => {
    btn.addEventListener('click', () => {
      monedaToggle.querySelectorAll('button').forEach(b => b.classList.remove('activo'));
